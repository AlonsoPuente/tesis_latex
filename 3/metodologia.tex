...
\begin{figure}[htbp]
	\begin{center}
		...
		\caption[Marco de trabajo del prototipo final]{Marco de trabajo del prototipo final. Fuente: Elaboración propia}
		\label{3:fig1}
	\end{center}
\end{figure}
...
\subsection{Muestra}
Se distribuyeron los subconjuntos de entrenamiento y prueba en proporciones de 80\% (21,800 registros) y 20\% (5,451 registros) respectivamente (\cite{pr_yuan2016textanalytics}, séptimo antecedente; \cite{pr_yu2018deeplearning}, undécimo antecedente; \cite{pr_chen2019keywords_crowdfunding}, decimoquinto antecedente; \cite{pr_mitra2014phrases}, segundo antecedente; \cite{pr_sawhney2016usingLT}, octavo antecedente).
...
\begin{table}[h!]
	...
	\begin{tabular}{ |m{3cm}|m{10cm}|m{2cm}|  }
		...
		\hline
	\end{tabular}
	\caption[Diccionario de datos del conjunto final entrenado]{Diccionario de datos del conjunto final entrenado. Fuente: Elaboración propia.}
	\label{3:table1}
\end{table}
...
\begin{itemize}
	...
	\begin{figure}[htbp]
		\begin{center}
			...
			\caption[Descripción de resultados de modelo descriptivo de ejemplo]{Descripción de resultados de modelo descriptivo de ejemplo. Fuente: \cite{gl_gonzalez2019auc}}
			\label{3:fig2}
		\end{center}
	\end{figure}
	...
	\begin{figure}[htbp]
		\begin{center}
			...
			\caption[Comparación de tres resultados de la curva AUC en el modelo]{Comparación de tres resultados de la curva AUC en el modelo. Fuente: \cite{gl_molina2017pediatria_curvaroc}}
			\label{3:fig3}
		\end{center}
	\end{figure}
...
\begin{figure}[h]
	\begin{center}
		...
		\caption[Flujograma de la recolección de conjuntos finales de datos]{Flujograma de la recolección de conjuntos finales de datos. Fuente: Elaboración propia.}
		\label{3:fig4}
	\end{center}
\end{figure}
...
\begin{figure}[h]
	\begin{center}
		...
		\caption[Cronograma de actividades de la investigación]{Cronograma de actividades de la investigación. Fuente: Elaboración propia}
		\label{3:fig5}
	\end{center}
\end{figure}
...
\begin{table}[h!]
	...
	\end{tabular}
	\caption[Presupuesto de los costos personales del autor]{Presupuesto de los costos personales del autor. Fuente: Elaboración propia.}
	\label{3:table3}
\end{table}
...
\begin{table}[h!]
	...
	\end{tabular}
	\caption[Presupuesto de los costos de las herramientas para el proyecto]{Presupuesto de los costos de las herramientas para el proyecto. Fuente: Elaboración propia.}
	\label{3:table4}
\end{table}
