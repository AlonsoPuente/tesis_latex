...
\begin{itemize}
	...
	\begin{figure}[htbp]
		\begin{center}
			\includegraphics[width=0.8\textwidth]{3/figures/auc_curves.jpg}
...
Una vez entrenado cada modelo de manera individual y posteriormente, apilados, fueron evaluados bajo 
