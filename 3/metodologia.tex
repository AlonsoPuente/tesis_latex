...
Se elaboró un cronograma de actividades de toda la investigación, mostrada en la Figura \ref{3:fig1}, contemplando desde el inicio de la misma, desarrollo, evaluación de resultados y sustentación en el mes de diciembre.
\begin{figure}[h]
	\begin{center}
