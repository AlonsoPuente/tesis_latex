...
\fancypagestyle{special}{%
	\fancyhead[L]{\changefont Predicción del estado de financiamiento de proyectos de tecnología en web de crowdfunding Kickstarter mediante modelo de Aprendizaje Profundo}
	\fancyhead[R]{\thepage}}
