...
\fancyhead[L]{\changefont Predicción del estado de financiamiento de proyectos de tecnología en web de crowdfunding Kickstarter mediante modelo(s) de Aprendizaje Automático}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Agregando librerías para que aparezca texto debajo de las ecuaciones.
...
\begin{document}
% Se añade esto para agregar la lista de ecuaciones en el Índice del documento	
...
%%Anexos
\appendix
\renewcommand{\appendixname}{Anexo} %Esto es para las páginas
\renewcommand{\appendixtocname}{Anexo} %Esto es para el índice
