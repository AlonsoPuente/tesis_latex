...
\begin{itemize}
	...
	\begin{itemize}
		...
		\begin{figure}[!ht]
			\begin{center}
				...
				\caption{Ejemplo de funcionamiento de una capa de incrustación. Fuente: \cite{tec_chengwei2018embedding}}
				\label{2:fig47}
			\end{center}
		\end{figure}
	...
	\begin{figure}[!ht]
		\begin{center}
			...
			\caption{Ejemplo de funcionamiento de bolsa de palabras. Fuente: \cite{tec_zhou2019bow}}
			\label{2:fig50}
		\end{center}
	\end{figure}
	...
	\begin{equcaption}[!ht]
		...
		\end{equation*}
		\caption[Fórmula de TF-IDF. Fuente: \cite{tec_hamdaoui2019tfidf}]{Fórmula de TF-IDF. Fuente: \cite{tec_hamdaoui2019tfidf}}
		\label{eq:tfidf}
	\end{equcaption}
