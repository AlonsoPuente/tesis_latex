...
\begin{itemize}
	...
	\begin{figure}[h]
		\begin{center}
			...
			\caption{Función de activación ReLU. Fuente: \cite{gl_mlfa2019redesneuronales}}
			\label{2:fig19}
		\end{center}
	\end{figure}
	...
	\begin{itemize}
		...
		\begin{equcaption}[!ht]
			...
			\end{equation*}
			\caption[Fórmula matemática de la convolución. Fuente: \cite{tec_figueroa_convolucion}]{Fórmula matemática de la convolución. Fuente: \cite{tec_figueroa_convolucion}}
	...
	\begin{figure}[h]
		\begin{center}
			...
			\caption{Hiperplano con dos clases separadas por una distancia m. Fuente: \cite{tec_betancourt2005svm}}
			\label{2:fig35}
		\end{center}
	\end{figure}
	...
	\begin{figure}[!ht]
		...
		\end{subfigure}
		\caption{Ejemplo de separación de 2 clases. Fuente: \cite{tec_betancourt2005svm}}
		\label{2:fig36}
	\end{figure}
...
\begin{itemize}
	...
	\begin{figure}[!ht]
		...
		\end{subfigure}
		\caption{Diferencias entre convoluciones según su dimensión. Fuente: \cite{tec_missinglink_conv1d}}
		\label{2:fig40}
	\end{figure}
	...
	\begin{figure}[!ht]
		\begin{center}
			...
			\caption{Arquitectura de modelo CNN para clasificación de oraciones. Fuente: \cite{tec_zhang2017cnn_sentenceclassification}}
			\label{2:fig41}
		\end{center}
	\end{figure}
	...
	\begin{itemize}
		...
		\begin{figure}[!ht]
			\begin{center}
				...
				\caption{Representación de arquitectura BiRNN de la palabra \textit{jumped} en la oración. Fuente: \cite{bk_goldberg2017nn_nlp}}
				\label{2:fig43}
			\end{center}
		\end{figure}
		...
		\begin{figure}[!ht]
			\begin{center}
				...
				\caption{Comparación entre arquitecturas LSTM y GRU. Fuente: \cite{tec_phi2018gru}}
				\label{2:fig44}
			\end{center}
		\end{figure}
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\begin{figure}[!ht]
			...
			\end{subfigure}
			\caption{Incrustaciones de palabras por GloVe. Fuente: \cite{tec_pennington2014glove}}
			\label{2:fig49}
		\end{figure}
		
	\end{itemize}

	\item \textbf{Bolsa de palabras} (\textit{Bag-of-Words} o \textit{BoW}): Consiste en una forma de extraer características de textos implicando un vocabulario de palabras conocidas y una métrica de presencia de éstas. Se le denomina Bolsa de palabras ya que no considera el orden o la estructura de las palabras dentro del documento, sólo conocer su presencia. El algoritmo relaciona la similitud entre documentos si tienen contenido similar \parencite{bk_brownlee2017deeplearning_nlp}.
\end{itemize}