...
\begin{itemize}
	...
	\begin{figure}[!ht]
		\begin{center}
			\includegraphics[width=0.5\textwidth]{2/figures/cnn_steps_for_nlp.png}
	...
	\begin{itemize}
		...
		\item \textbf{Unidad Recurrente Cerrada} (\textit{Gated Recurrent Unit} o GRU): Este modelo se desarrolló con la intención de simplificar las LSTM. Sin embargo, al compararse los resultados entre estos 3 tipos de modelos, por lo general tuvo mejor desempeño la LSTM.
	\end{itemize}
	
	\item \textbf{Modelo Secuencia a Secuencia} (\textit{Sequence-to-Sequence Model} o \textit{Seq2seq Model}): 
	
	\item \textbf{Aprendizaje Profundo Multimodal y Multitarea} (\textit{Multimodal and Multitask Deep Learning}):
\end{itemize}