...
\citeauthor{pr_sawhney2016usingLT} realizaron la publicación «Using Language to Predict Kickstarter Success» para el Departamento de Ciencia de la Computación de la Universidad Standford. Este fue titulado \citetitle{pr_sawhney2016usingLT} la cual traducida al español significa «Usando lenguaje para predecir el éxito en Kickstarter».
...
\citeauthor{pr_chen2013kickpredict} realizaron la publicación «KickPredict: Predicting Kickstarter Success» para el Departamento de Ciencias Computacionales y Matemáticas del Instituto de Tecnología de California. Este fue titulado \citetitle{pr_chen2013kickpredict} la cual traducida al español significa «KickPredict: Prediciendo el éxito en Kickstarter».
