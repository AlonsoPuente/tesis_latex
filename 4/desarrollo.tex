...
\begin{figure}[!ht]
	\begin{center}
		...
		\caption[Vista (agosto 2019) del website Web Robots]{Vista (agosto 2019) del website Web Robots.\\
...
\begin{figure}[htbp]
	\begin{center}
		\includegraphics[width=0.65\textwidth]{4/figures/alteryx_flux_part1.png}	
		\includegraphics[width=0.65\textwidth]{4/figures/alteryx_flux_part2.png}
		\caption[Flujo de trabajo del conjunto final de metainformación en Alteryx Designer]{Flujo de trabajo del conjunto final de metainformación en Alteryx Designer.\\
		Fuente: Elaboración propia.}
		\label{4:fig4}
	\end{center}
\end{figure}
...
\begin{table}[h!]
	\caption[Diccionario de datos del dataset de metainformación generado]{Diccionario de datos del dataset de metainformación generado.}
	\label{4:table1}
	\centering
	\small
...
\begin{landscape}
	...
	\begin{figure}[!ht]
		\begin{center}
			\includegraphics[width=1.17\textwidth]{4/figures/final_stacked_model.png}
